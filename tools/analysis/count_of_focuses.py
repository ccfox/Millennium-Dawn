    ...
    if mode == "file stats" or mode == "file":
        ...
        while True:
            ...
            if path_to_focuses == "exit" or path_to_focuses == "Exit":
                ...
                break
            try:
                files_with_focuses = os.listdir(path_to_focuses)
            except FileNotFoundError:
            ...
            for file_i in range(len(files_with_focuses)):
                ...
                if focuses_in_this_file > 0:
                    list_fc.append(
                        str(focuses_in_this_file)
                        + " "
                        + str(files_with_focuses[file_i])
                    )
